...
namespace GolfScheduler.Migrations
{
    ...
    [Migration("20260107020537_AddDistributionEmailsToPlayer")]
    partial class AddDistributionEmailsToPlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyApp.Models.Player", b =>
                {
                    ...
                    b.Property<string>("DistributionEmailsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyApp.Models.Player", b =>
                {
                    b.HasOne("MyApp.Models.ApplicationUser", null)
                        .WithOne("Player")
                        .HasForeignKey("MyApp.Models.Player", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
