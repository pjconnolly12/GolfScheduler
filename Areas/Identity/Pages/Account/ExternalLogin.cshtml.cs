...
namespace GolfScheduler.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                await _playerService.EnsurePlayerForUser(existingUser);
                await _signInManager.SignInAsync(existingUser, isPersistent: false, info.LoginProvider);
                return LocalRedirect(returnUrl); // user already exists, sign in and redirect
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await _playerService.EnsurePlayerForUser(newUser);
